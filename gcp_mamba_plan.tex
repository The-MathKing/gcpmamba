...
\midrule
\textbf{GCP-Mamba (Seen 2/2)} & $1.1256 \pm 0.2584$ & $0.7792 \pm 0.0167$ & $p=0.258$ \textsuperscript{ns} \\
\textbf{GCP-Mamba (Seen 1/2)} & $1.3252 \pm 0.0838$ & $0.7493 \pm 0.0028$ & $p=0.237$ \textsuperscript{ns} \\
\textbf{GCP-Mamba (Seen 0/2)} & $1.3609 \pm 0.2165$ & $0.7489 \pm 0.0134$ & $p=0.272$ \textsuperscript{ns} \\
\midrule
BaseMamba (Seen 2/2)          & $1.1694 \pm 0.2802$ & $0.7797 \pm 0.0168$ & -- \\
BaseMamba (Seen 1/2)          & $1.3780 \pm 0.0827$ & $0.7513 \pm 0.0021$ & -- \\
BaseMamba (Seen 0/2)          & $1.4200 \pm 0.2721$ & $0.7502 \pm 0.0147$ & -- \\
\bottomrule
\end{tabular}
\end{table}
\vspace{0.2cm}

As shown in Figure~\ref{fig:ablation} and Table~\ref{tab:metrics}, graph-conditioned GCP-Mamba consistently achieves lower MSE than the unconditioned BaseMamba across all generalization tiers. The Seen 0/2 performance delta ($\Delta\text{MSE} = 0.0591$) represents a 4.2\% improvement in prediction error for completely uncharacterized combinations. However, a paired Student's $t$-test on the 3-fold MSE values yields $p \approx 0.26$--$0.27$, indicating that the delta does not yet reach the conventional $p < 0.05$ threshold for the current sample size. This is expected for a 3-fold evaluation on 2,700 cells with relatively small effect sizes; the directional consistency of the MSE advantage across all three folds and all three splits provides evidence of a genuine architectural signal. Definitive statistical significance is expected upon scaling to the full Norman 2019 K562 dataset ($\sim$100,000 cells), where increased statistical power will discriminate the architectural effect from fold-level variance.
